...
<img src="https://github.com/user-attachments/assets/b43f5752-2cc4-42bd-b19b-69d32d4c6bd6"  width="300" height="550"/>
...
## 📚 팀원 소개 및 역할
+ 서교진 : 시작 화면, 로그인 / 회원가입, 전체적인 디자인, 프로덕트 배포 및 관리

+ 박병준 : 설정, 게시글 수정 / 삭제, 조회 화면
